...
public class DriveAgent extends StaticAgent implements ActivityDetectorInterface, AgentNotificationInterface {
	...
	public HashMap<String, String> getPreferencesMap() {
		...
		//rohans code this setting is not applicable for the japanese version of this application...
	...
	public AgentUIElement[] getSettings(AgentConfigurationProvider acp) {
		...
		//rohans code decreasing the size of the settings array by value 2 cause two elements are removed
		//in the japanese version of this code...
		...
		//rohans code this settings are not applicable for the japanese version of this application....
