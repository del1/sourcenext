...
public class ParkingHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mContentView = (ScrollView) inflater.inflate(R.layout.fragment_parking_agent_info, null);

        addRecordButton((LinearLayout) mContentView.findViewById(R.id.preMapItems));

        addMap((LinearLayout) mContentView.findViewById(R.id.configuration_items), (LinearLayout) mContentView.findViewById(R.id.mapItems));
        requestLocationPermission();
    ...
    private void setCurrentLocationOnMap() {
        Toast.makeText(getContext(), getActivity().getResources().getString(R.string.parking_map_notification),Toast.LENGTH_LONG).show();
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            //check for the current platform on which the application is running...
            if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                requestLocationPermission();
                //requestPermissions(new String[] {Manifest.permission.ACCESS_FINE_LOCATION,Manifest.permission.ACCESS_COARSE_LOCATION,Manifest.permission.INTERNET},myLocationRequestConstant);
            } else {
